...
class _MapPageState extends State<MapPage> {
  final ActiviteService _activiteService = ActiviteService(); // Instance du service
  ...
  void _initializeLocations() async {
    ...
    final staticData = [
      {"lat": 12.6392, "lng": -8.0029, "title": "Monument de l'Indépendance", "color": Colors.yellow, "image": "assets/images/independance.jpg"},
      {"lat": 12.6530, "lng": -8.0020, "title": "Monument de la Paix", "color": Colors.yellow, "image": "assets/images/paix.jpg"},
      {"lat": 16.2700, "lng": -0.0433, "title": "Tombeau des Askia", "color": Colors.yellow, "image": "assets/images/tombeau.jpg"},
      {"lat": 14.4433, "lng": -11.4367, "title": "Porte de Tombouctou", "color": Colors.yellow, "image": "assets/images/porte.jpg"},
      {"lat": 12.6470, "lng": -8.0038, "title": "Statue de Kwame Nkrumah", "color": Colors.yellow, "image": "assets/images/nkuruma.jpg"},
      {"lat": 14.4974, "lng": -4.2019, "title": "Monument de la Bataille de Ségou", "color": Colors.yellow, "image": "assets/images/monument_bataille_segou.jpg"},
      {"lat": 13.9086, "lng": -4.5556, "title": "Stèle de Soundiata Keïta", "color": Colors.yellow, "image": "assets/images/stele_soundiata.jpg"},
      {"lat": 11.3172, "lng": -5.6662, "title": "Statue de Babemba Traoré", "color": Colors.yellow, "image": "assets/images/statue_babemba.jpg"},
      {"lat": 12.8600, "lng": -5.4689, "title": "Monument Samory Touré", "color": Colors.yellow, "image": "assets/images/samoryMonument.jpg"},
      {"lat": 14.5126, "lng": -4.1186, "title": "Place de la Liberté (Ségou)", "color": Colors.yellow, "image": "assets/images/place_liberte.jpg"},
      {"lat": 12.6152, "lng": -7.9844, "title": "Tour d'Afrique", "color": Colors.yellow, "image": "assets/images/tour_afrique.jpg"},
      {"lat": 12.6496, "lng": -8.0002, "title": "Monument des Martyrs", "color": Colors.yellow, "image": "assets/images/monument_martyrs.jpg"},
      {"lat": 16.7739, "lng": -3.0074, "title": "Fort de Médine", "color": Colors.yellow, "image": "assets/images/fort_medine.jpg"},
      {"lat": 14.4560, "lng": -11.4394, "title": "Tombouctou", "color": Colors.green, "image": "assets/images/tombouctouN.jpg"},
      {"lat": 14.3526, "lng": -10.7810, "title": "Grande Mosquée de Djenné", "color": Colors.green, "image": "assets/images/mosquee_djenne.jpg"},
      {"lat": 13.4450, "lng": -9.4858, "title": "Falaise de Bandiagara", "color": Colors.green, "image": "assets/images/falaise_bandiagara.jpg"},
      {"lat": 13.9058, "lng": -3.5269, "title": "Ville ancienne de Ségou", "color": Colors.green, "image": "assets/images/segou.jpg"},
      {"lat": 14.3333, "lng": -3.5833, "title": "Pays Dogon", "color": Colors.green, "image": "assets/images/pays_dogon.jpg"},
      {"lat": 13.9049, "lng": -4.5532, "title": "Delta intérieur du Niger", "color": Colors.green, "image": "assets/images/delta_niger.jpg"},
      {"lat": 13.5500, "lng": -5.1000, "title": "Lac Débo", "color": Colors.green, "image": "assets/images/lac_debo.jpg"},
      {"lat": 13.6333, "lng": -5.5000, "title": "Réserve de la Boucle du Baoulé", "color": Colors.green, "image": "assets/images/boucle_baoule.jpg"},
      {"lat": 12.6125, "lng": -7.9747, "title": "Parc national de Bamako", "color": Colors.green, "image": "assets/images/parc_bamako.jpg"},
      {"lat": 16.6858, "lng": -2.8844, "title": "Désert de l'Adrar", "color": Colors.green, "image": "assets/images/desert_adrar.jpg"},
      {"lat": 15.9167, "lng": -4.9167, "title": "Lac Faguibine", "color": Colors.green, "image": "assets/images/lac_faguibine.jpg"},
      {"lat": 14.2500, "lng": -3.2500, "title": "Plateau Dogon", "color": Colors.green, "image": "assets/images/plateau_dogon.jpg"},
      {"lat": 13.8000, "lng": -10.8333, "title": "Cascade de Banfora", "color": Colors.green, "image": "assets/images/cascade_banfora.jpg"},
      {"lat": 16.2667, "lng": -0.0500, "title": "Marché de Gao", "color": Colors.green, "image": "assets/images/marche_gao.jpg"},
      {"lat": 15.1167, "lng": -1.3333, "title": "Dune Rose de Koyma", "color": Colors.green, "image": "assets/images/dune_rose_koyma.jpg"},
      {"lat": 15.2786, "lng": -1.6925, "title": "Main de Fatima (Hombori Tondo)", "color": Colors.green, "image": "assets/images/main_fatima.jpg"},
    ];
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            usingBackendData
                ? "Données chargées depuis le serveur (${locations.length} activités)"
                : "Données locales chargées (${locations.length} lieux)",
          ),
  ...
  List<Marker> get _markers => locations.map((loc) {
    return Marker(
      ...
      height: 40,
      child: Tooltip(
        message: (loc["title"] ?? "").toString(),
        child: IconButton(
          icon: Icon(Icons.location_on, color: loc["color"], size: 30),
    ...
    if (newActivity != null) {
      setState(() {
        locations.insert(0, {
          ...
          "lng": -6.0,
          "title": newActivity['nom'],
          "color": Colors.orange,
          "image": newActivity['imagePath'] ?? "assets/default_activity.jpg",
        });
        _centerOnLocation(13.0 + locations.length * 0.02, -6.0);
      });
    }
  }
...
class _MapPageState extends State<MapPage> {
  ...
  void _initializeLocations() async {
    ...
    try {
      ...
      if (apiActivites != null) {
        for (var activite in apiActivites) {
          // Add null check for the item itself
          if (activite != null && activite is Map<String, dynamic>) {
            double lat = _getSafeDouble(activite, 'latitude');
            double lng = _getSafeDouble(activite, 'longitude');
      ...
      if (finalData.isNotEmpty) {
        ...
        setState(() {
          locations.clear();
          locations.addAll(finalData);
        });
        _centerOnLocation(finalData.first["lat"], finalData.first["lng"]);
      } else {
        setState(() {
          locations.clear();
          locations.addAll(staticData);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            usingBackendData
                ? "Données chargées depuis le serveur (${locations.length} activités)"
                : "Données locales chargées (${locations.length} lieux). Vérifiez votre connexion internet.",
          ),
          duration: Duration(seconds: 4),
          backgroundColor: usingBackendData ? Colors.green : Colors.red,
        ),
      );
    }
  }
  ...
  void _addUserActivity() async {
    ...
    if (newActivity != null && newActivity is Map<String, dynamic>) {
      setState(() {
        locations.insert(0, {
          "lat": 13.0 + locations.length * 0.02,
          "lng": -6.0,
...
class _MapPageState extends State<MapPage> {
  ...
  void _addUserActivity() async {
    ...
    if (newActivity != null && newActivity is Map<String, dynamic>) {
      setState(() {
        locations.insert(0, {
          "lat": newActivity['latitude'],
          "lng": newActivity['longitude'],
          "title": newActivity['nom'],
          "color": Colors.orange,
          "image": newActivity['imagePath'] ?? "assets/default_activity.jpg",
          "isBackendData": false,
        ...
        _centerOnLocation(newActivity['latitude'], newActivity['longitude']);
      });
    }
  }
                          ...
                          child: Row(
                            children: [
                              ...
                              if (loc["isBackendData"] == true) ...[
                                SizedBox(width: 4),
                                Icon(Icons.cloud, size: 12, color: Colors.blue),
                              ],
                            ],
                          ),
                        ),
