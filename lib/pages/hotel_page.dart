...
import 'profil_page.dart'; // Import ajouté pour la redirection
...
class _HotelPageState extends State<HotelPage> {
  ...
  void _handleReservation(Map<String, dynamic> hotel) async {
    // Vérifier si l'utilisateur est connecté
    if (!_isUserLoggedIn) {
      ...
      // Aller à la page de réservation avec les données de l'utilisateur
      Navigator.push(
        context,
        MaterialPageRoute(
